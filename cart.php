...
<body>
    ...
    <div class="small-container cart-page">
        <form id="cart-form" action="cart.php?action=submit" method="POST">
            ...
            <hr>
            <div><label>Người nhận: </label><input type="text" value="" name="name" style="width: 80%;" /></div>
            <div><label>Điện thoại: </label><input type="text" value="" name="phone" style="width: 80%;" /></div>
            <div><label>Địa chỉ: </label><input type="text" value="" name="address" style="width: 80%;" /></div>
            <div><label>Ghi chú: </label><textarea name="note" cols="50" rows="7"></textarea></div>
            <a href="map.php"><input type="submit" name="order_click" value="Đặt hàng" style="line-height:32px; height:50px;background: #ff523b;font-size:20px; color:#fff; border-radius:30px; width:30%;margin: 40px 0  0 350px; "></a>
