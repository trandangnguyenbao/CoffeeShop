                ...
                <?php
                        ...
                        while ($row = mysqli_fetch_assoc($query)) {?>
                            <tr style="background-color: aliceblue;">
                                ...
                                <td style="border: 1px solid #b4b2af;text-align: center;">
                                    <a class="btn btn-warning" style="height: 40px; width: 100px; background-color:#ffc107; border-radius: 0.25rem" href="admin.php?page_layout=sua&id=<?php echo $row['id']; ?>">Sửa</a>

                                    <a onclick="return Del('<?php  echo $row['name'];?>')" class="btn btn-danger" style="height: 40px; width: 100px; background-color:#dc3545; border-radius: 0.25rem;" href="admin.php?page_layout=xoa&id=<?php echo $row['id']; ?>">Xóa</a>
                                </td>
                            </tr>
                        <?php } ?>
