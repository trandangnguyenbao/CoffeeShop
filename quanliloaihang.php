                ...
                <table class="table bordered">
                    <thead class="thead-dark">
                        ...
                        <tr style="background-color: #737475;color: #fff; height: 60px;">
                            ...
                            <th style="border: 1px solid #fff; text-align: center; width:30%">Tên Loại Hàng</th>
                            <th style="border: 1px solid #fff; text-align: center;width:15%">Mã Loại Hàng </th>
                            <th style="border: 1px solid #fff; text-align: center;width:35%">Hình Ảnh</th>
                            <th style="border: 1px solid #fff; text-align: center;width:10%">Hành động</th>
                        </tr>
                    </thead>
                    <?php
                    $i = 1;
                    while ($row = mysqli_fetch_array($query)) { ?>
                        <tr style="background-color: aliceblue;">
                            ...
                            <td style="border: 1px solid #b4b2af;text-align: center;">
                                <a style="height: 40px; width: 100px; background-color:#ffc107; border-radius: 0.25rem" class="btn btn-warning" href="sualoaihang.php?id_type=<?php echo $row['id_type']; ?>">Sửa</a>

                                <a onclick="return Del('<?php echo $row['name']; ?>')" style="height: 40px; width: 100px; background-color:#dc3545; border-radius: 0.25rem;" class="btn btn-danger" href="xoaloaihang.php?id_type=<?php echo $row['id_type']; ?>">Xóa</a>
                            </td>
                        </tr>
                    <?php } ?>
